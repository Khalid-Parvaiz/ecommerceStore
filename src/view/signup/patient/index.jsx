...
export default function PatientSignUp() {
    ...
    return (
        <Formik
            initialValues={{ email: '', password: '', PatientName: '', age: '' }}
            validate={values => {
                const errors = {};
                        ...
                        <div className='w-150'>
                            ...
                            <div >
                                <Form className="flex flex-wrap gap-5 justify-center">
                                    <h1 className='text-4xl font-medium m-10'>Sign Up as a <span className='text-green-500 font-bold'>Patient</span></h1>

                                    <div name='patientName' className='w-65 flex flex-col gap-2 '>
                                        <div className='relative left-2 flex gap-1.5 items-center'>
                                            <label htmlFor="patientName" className='text-green-700'>Doctor Name</label>
                                            <ErrorMessage name='patientName' component='div' className='text-red-500 text-[10px]' />
                                        </div>
                                        <Field className="w-full h-10 border-green-500 border-2 rounded-sm p-2" type='text' name='patientName' placeholder='John' id='patientName' />
                                    </div>

                                    <div name='age' className='w-65 flex flex-col gap-2 '>
                                        <div className='relative left-2 flex gap-1.5 items-center'>
                                            <label htmlFor="age" className='text-green-700'>Clinic Name</label>
                                            <ErrorMessage name='age' component='div' className='text-red-500 text-[10px]' />
                                        </div>
                                        <Field className="w-full h-10 border-green-500 border-2 rounded-sm p-2" type='number' name='age' placeholder='years old' id='age' />
                                    </div>
